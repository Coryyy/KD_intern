...
#Test0 CFG
CFG.TEST = CN()
CFG.TEST.TEMPERATURE = 4
CFG.TEST.LOSS = CN()
CFG.TEST.LOSS.TASK_WEIGHT = 1
CFG.TEST.LOSS.KL_WEIGHT = 8
CFG.TEST.LOSS.TAT_WEIGHT = 39


#Test2 CFG
CFG.TEST2 = CN()
CFG.TEST2.TEMPERATURE = 4
CFG.TEST2.LOSS = CN()
CFG.TEST2.LOSS.TASK_WEIGHT = 1
CFG.TEST2.LOSS.GT_WEIGHT = 10
CFG.TEST2.LOSS.NON_GT_WEIGHT = 2

#DIST CFG
CFG.DIST = CN()
CFG.DIST.LOSS = CN()
CFG.DIST.LOSS.APHA = 1
CFG.DIST.LOSS.BETA= 2
CFG.DIST.LOSS.GAMMA = 2
